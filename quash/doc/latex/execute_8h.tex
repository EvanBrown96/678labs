...
\subsubsection[{\texorpdfstring{write\+\_\+env(const char $\ast$env\+\_\+var, const char $\ast$val)}{write_env(const char *env_var, const char *val)}}]{\setlength{\rightskip}{0pt plus 5cm}void write\+\_\+env (
\begin{DoxyParamCaption}
\item[{const char $\ast$}]{env\+\_\+var, }
