...
\begin{DoxyCompactItemize}
\item 
void \hyperlink{buddy_8c_afd24c17a9f60f637336f5943f053cce2}{buddy\+\_\+split} (int order)
\item 
\hyperlink{structpage__t}{page\+\_\+t} $\ast$ \hyperlink{buddy_8c_acfb1f99dbcfa5ecff9fd819109e035bc}{buddy\+\_\+combine} (\hyperlink{structpage__t}{page\+\_\+t} $\ast$the\+\_\+page, \hyperlink{structpage__t}{page\+\_\+t} $\ast$buddy\+\_\+page)
\item 
...
\subsubsection[{\texorpdfstring{A\+D\+D\+R\+\_\+\+T\+O\+\_\+\+P\+A\+GE}{ADDR_TO_PAGE}}]{\setlength{\rightskip}{0pt plus 5cm}\#define A\+D\+D\+R\+\_\+\+T\+O\+\_\+\+P\+A\+GE(
...
\subsubsection[{\texorpdfstring{B\+U\+D\+D\+Y\+\_\+\+A\+D\+DR}{BUDDY_ADDR}}]{\setlength{\rightskip}{0pt plus 5cm}\#define B\+U\+D\+D\+Y\+\_\+\+A\+D\+DR(
\begin{DoxyParamCaption}
\item[{}]{addr, }
\item[{}]{o}
\end{DoxyParamCaption}
...
\subsubsection[{\texorpdfstring{M\+A\+X\+\_\+\+O\+R\+D\+ER}{MAX_ORDER}}]{\setlength{\rightskip}{0pt plus 5cm}\#define M\+A\+X\+\_\+\+O\+R\+D\+ER~20}\hypertarget{buddy_8c_ab08dffec08ac450d78d4c062b571939e}{}\label{buddy_8c_ab08dffec08ac450d78d4c062b571939e}
...
\subsubsection[{\texorpdfstring{M\+I\+N\+\_\+\+O\+R\+D\+ER}{MIN_ORDER}}]{\setlength{\rightskip}{0pt plus 5cm}\#define M\+I\+N\+\_\+\+O\+R\+D\+ER~12}\hypertarget{buddy_8c_a23bae2b7cd4008c90256be146e21cccf}{}\label{buddy_8c_a23bae2b7cd4008c90256be146e21cccf}
...
\subsubsection[{\texorpdfstring{P\+A\+G\+E\+\_\+\+S\+I\+ZE}{PAGE_SIZE}}]{\setlength{\rightskip}{0pt plus 5cm}\#define P\+A\+G\+E\+\_\+\+S\+I\+ZE~(1$<$$<${\bf M\+I\+N\+\_\+\+O\+R\+D\+ER})}\hypertarget{buddy_8c_a7d467c1d283fdfa1f2081ba1e0d01b6e}{}\label{buddy_8c_a7d467c1d283fdfa1f2081ba1e0d01b6e}
...
\subsubsection[{\texorpdfstring{P\+A\+G\+E\+\_\+\+T\+O\+\_\+\+A\+D\+DR}{PAGE_TO_ADDR}}]{\setlength{\rightskip}{0pt plus 5cm}\#define P\+A\+G\+E\+\_\+\+T\+O\+\_\+\+A\+D\+DR(
\begin{DoxyParamCaption}
\item[{}]{page\+\_\+idx}
\end{DoxyParamCaption}
...
\subsubsection[{\texorpdfstring{U\+S\+E\+\_\+\+D\+E\+B\+UG}{USE_DEBUG}}]{\setlength{\rightskip}{0pt plus 5cm}\#define U\+S\+E\+\_\+\+D\+E\+B\+UG~0}\hypertarget{buddy_8c_a260e435d62aa44fda8a1368df99c4a89}{}\label{buddy_8c_a260e435d62aa44fda8a1368df99c4a89}
Buddy Allocator
...
\subsubsection[{\texorpdfstring{buddy\+\_\+alloc(int size)}{buddy_alloc(int size)}}]{\setlength{\rightskip}{0pt plus 5cm}void$\ast$ buddy\+\_\+alloc (
\begin{DoxyParamCaption}
\item[{int}]{size}
\end{DoxyParamCaption}
...
Definition at line 190 of file buddy.\+c.

\index{buddy.\+c@{buddy.\+c}!buddy\+\_\+combine@{buddy\+\_\+combine}}
\index{buddy\+\_\+combine@{buddy\+\_\+combine}!buddy.\+c@{buddy.\+c}}
\subsubsection[{\texorpdfstring{buddy\+\_\+combine(page\+\_\+t $\ast$the\+\_\+page, page\+\_\+t $\ast$buddy\+\_\+page)}{buddy_combine(page_t *the_page, page_t *buddy_page)}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf page\+\_\+t}$\ast$ buddy\+\_\+combine (
\begin{DoxyParamCaption}
\item[{{\bf page\+\_\+t} $\ast$}]{the\+\_\+page, }
\item[{{\bf page\+\_\+t} $\ast$}]{buddy\+\_\+page}
\end{DoxyParamCaption}
)}\hypertarget{buddy_8c_acfb1f99dbcfa5ecff9fd819109e035bc}{}\label{buddy_8c_acfb1f99dbcfa5ecff9fd819109e035bc}
combines two blocks
...
assumptions made\+:
\begin{DoxyItemize}
\item buddy\+\_\+page points to the correct buddy of the\+\_\+page based on the\+\_\+page\textquotesingle{}s block\+\_\+size
\item the\+\_\+page is properly marked as free
\end{DoxyItemize}


\begin{DoxyParams}{Parameters}
{\em the\+\_\+page} & pointer to the page at the start of a block \\
\hline
{\em buddy\+\_\+page} & pointer to the page at the start of that block\textquotesingle{}s buddy \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
pointer to the page resulting from the attempted combination 
\end{DoxyReturn}
...
\subsubsection[{\texorpdfstring{buddy\+\_\+dump()}{buddy_dump()}}]{\setlength{\rightskip}{0pt plus 5cm}void buddy\+\_\+dump (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
Definition at line 271 of file buddy.\+c.

\index{buddy.\+c@{buddy.\+c}!buddy\+\_\+free@{buddy\+\_\+free}}
\index{buddy\+\_\+free@{buddy\+\_\+free}!buddy.\+c@{buddy.\+c}}
\subsubsection[{\texorpdfstring{buddy\+\_\+free(void $\ast$addr)}{buddy_free(void *addr)}}]{\setlength{\rightskip}{0pt plus 5cm}void buddy\+\_\+free (
\begin{DoxyParamCaption}
\item[{void $\ast$}]{addr}
\end{DoxyParamCaption}
...
Definition at line 233 of file buddy.\+c.

\index{buddy.\+c@{buddy.\+c}!buddy\+\_\+init@{buddy\+\_\+init}}
\index{buddy\+\_\+init@{buddy\+\_\+init}!buddy.\+c@{buddy.\+c}}
\subsubsection[{\texorpdfstring{buddy\+\_\+init()}{buddy_init()}}]{\setlength{\rightskip}{0pt plus 5cm}void buddy\+\_\+init (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
Definition at line 155 of file buddy.\+c.

\index{buddy.\+c@{buddy.\+c}!buddy\+\_\+split@{buddy\+\_\+split}}
\index{buddy\+\_\+split@{buddy\+\_\+split}!buddy.\+c@{buddy.\+c}}
\subsubsection[{\texorpdfstring{buddy\+\_\+split(int order)}{buddy_split(int order)}}]{\setlength{\rightskip}{0pt plus 5cm}void buddy\+\_\+split (
\begin{DoxyParamCaption}
\item[{int}]{order}
\end{DoxyParamCaption}
)}\hypertarget{buddy_8c_afd24c17a9f60f637336f5943f053cce2}{}\label{buddy_8c_afd24c17a9f60f637336f5943f053cce2}
splits the first free page of the given order into two smaller pages

assumptions made\+:
\begin{DoxyItemize}
\item the first page of the free list of the given order has been properly marked as free
\item there are no free blocks of size order-\/1 (otherwise why would we need to split?)
\end{DoxyItemize}


\begin{DoxyParams}{Parameters}
{\em order} & size of block to split up \\
\hline
\end{DoxyParams}
...
\subsubsection[{\texorpdfstring{free\+\_\+area}{free_area}}]{\setlength{\rightskip}{0pt plus 5cm}struct {\bf list\+\_\+head} free\+\_\+area\mbox{[}{\bf M\+A\+X\+\_\+\+O\+R\+D\+ER}+1\mbox{]}}\hypertarget{buddy_8c_a6d390a89d1f6c149cef6284d2c0351df}{}\label{buddy_8c_a6d390a89d1f6c149cef6284d2c0351df}


Definition at line 62 of file buddy.\+c.

\index{buddy.\+c@{buddy.\+c}!g\+\_\+memory@{g\+\_\+memory}}
\index{g\+\_\+memory@{g\+\_\+memory}!buddy.\+c@{buddy.\+c}}
\subsubsection[{\texorpdfstring{g\+\_\+memory}{g_memory}}]{\setlength{\rightskip}{0pt plus 5cm}char g\+\_\+memory\mbox{[}1$<$$<$ {\bf M\+A\+X\+\_\+\+O\+R\+D\+ER}\mbox{]}}\hypertarget{buddy_8c_ad6d688a63e574ba24b0247b2bec1e31d}{}\label{buddy_8c_ad6d688a63e574ba24b0247b2bec1e31d}


Definition at line 65 of file buddy.\+c.

\index{buddy.\+c@{buddy.\+c}!g\+\_\+pages@{g\+\_\+pages}}
\index{g\+\_\+pages@{g\+\_\+pages}!buddy.\+c@{buddy.\+c}}
\subsubsection[{\texorpdfstring{g\+\_\+pages}{g_pages}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf page\+\_\+t} g\+\_\+pages\mbox{[}(1$<$$<$ {\bf M\+A\+X\+\_\+\+O\+R\+D\+ER})/{\bf P\+A\+G\+E\+\_\+\+S\+I\+ZE}\mbox{]}}\hypertarget{buddy_8c_afbc14d1f5ec9e22ef3e00d9d33ee0c08}{}\label{buddy_8c_afbc14d1f5ec9e22ef3e00d9d33ee0c08}


Definition at line 68 of file buddy.\+c.
